...
It produces the `theodolite-0.6.1-runner.jar` file in the `/build` directory. Be aware that it’s not
...
The application is now runnable using `java -jar build/theodolite-0.6.1-runner.jar`.
